(function () {
  ...
  /** @ngInject */
  function searchPageAPI($resource, appConfig, $q ,appConfig, UserProfileApi) {
      var $q = $q; 
      var vm = this;
      ...
      var chunkedRequestWithPromise = function (url) {
      ...
      function getTrendingKnowledge1(searchText , categoryName) {
        return api.getTrendingKnowledge1.query({ searchKeyword:  searchText , docType : categoryName }).$promise;
    }
