(function () {
    ...
    angular
        ...
        .controller('KnowledgePublicationsController', KnowledgePublicationsController);

    /** @ngInject */
    function KnowledgePublicationsController($scope, KnowledgeDocumentApi, KnowledgeDiscoveryApi, SearchApi, InsightsCommonService, InsightsApi, MasterDataCopApi, $stateParams) {
        var vm = this;
        vm.loading = false;
        // vm.isfirstLoadCalendar = true; //fix show curent in calendar
        vm.arrSource = [{ sourceName: 'All Source', id: 0 }];
        vm.selectSource = { sourceName: 'All Source', id: 0 };
        vm.arrSortby = [
        ...
        function getDocumentFilter() {
            ...
            KnowledgeDiscoveryApi.api.Build.get({ type: 'Pub' }).$promise.then(function (res) {
                vm.arrSource = _.concat(vm.arrSource, res.sources);
            });
        }
        getDocumentFilter();
        ...
        function getDataDocumentType() {
            ...
            return {
                ...
                filterBy: [
                    { field: 'Source', value: _.isEmpty(vm.selectSource) ? 0 : vm.selectSource.id }
                ],
        ...
        vm.changeSourceInMobile = function (source) {
