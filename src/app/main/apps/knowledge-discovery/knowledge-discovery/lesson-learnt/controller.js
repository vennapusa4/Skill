(function () {
    ...
    angular
        ...
        .controller('KnowledgeLessonLearntController', KnowledgeLessonLearntController);

    /** @ngInject */
    function KnowledgeLessonLearntController($scope, KnowledgeDocumentApi, KnowledgeDiscoveryApi, SearchApi, InsightsCommonService, InsightsApi, MasterDataCopApi, $stateParams) {
        var vm = this;
        vm.loading = false;
        vm.arrType = [{ typeName: "All Type", id: 0 }];
        vm.selectType = { typeName: "All Type", id: 0 };
        vm.arrSortby = [
        ...
        vm.recordcount = 0;
        vm.maxSize = 5;
        vm.documentType = 'Lessons Learnt';
        vm.SearchResult = {};
        ...
        function getDocumentFilter() {
            ...
            KnowledgeDiscoveryApi.api.Build.get({ type: 'LL' }).$promise.then(function (res) {
                vm.arrType = _.concat(vm.arrType, res.learnTypes);
            });
        }
        getDocumentFilter();
        ...
        function getDataDocumentType() {
            ...
            return {
                ...
                filterBy: [
                    { field: 'LessonLearntType', value: _.isEmpty(vm.selectType) ? 0 : vm.selectType.id }
                ],
        ...
        vm.changeTypeInMobile = function (selectType) {
