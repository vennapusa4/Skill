(function () {
    ...
    angular
        ...
        .controller('KnowledgeBestListPracticesController', KnowledgeBestListPracticesController);

    /** @ngInject */
    function KnowledgeBestListPracticesController($scope, KnowledgeDocumentApi, SearchApi, InsightsCommonService, InsightsApi, MasterDataCopApi, $stateParams) {
        var vm = this;
        vm.loading = false;
        ...
        vm.recordcount = 0;
        vm.maxSize = 5;
        vm.documentType = 'Best Practices';
        vm.SearchResult = {};
