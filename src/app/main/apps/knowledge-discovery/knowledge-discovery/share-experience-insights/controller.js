(function () {
    ...
    angular
        ...
        .controller('KnowledgeShareExperienceInsightsController', KnowledgeShareExperienceInsightsController);

    /** @ngInject */
    function KnowledgeShareExperienceInsightsController($scope, KnowledgeDocumentApi, SearchApi, InsightsCommonService, InsightsApi, $stateParams, MasterDataCopApi) {
        var vm = this;
        vm.loading = false;
