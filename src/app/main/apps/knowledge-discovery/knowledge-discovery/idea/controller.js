(function () {
    ...
    angular
        ...
        .controller('KnowledgeIdeaController', KnowledgeIdeaController);

    /** @ngInject */
    function KnowledgeIdeaController($scope, KnowledgeDocumentApi, SearchApi, InsightsCommonService, InsightsApi, $stateParams, MasterDataCopApi) {
        var vm = this;
        vm.loading = false;
