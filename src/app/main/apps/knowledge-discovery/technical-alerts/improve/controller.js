(function () {
    ...
    angular
      ...
      .controller('KnowledgeTechnicalAlertsImproveController', KnowledgeTechnicalAlertsImproveController);

    /** @ngInject */
  function KnowledgeTechnicalAlertsImproveController($scope, $state, $stateParams, $location, $anchorScroll, $timeout, KnowledgeDiscoveryApi, MasterDataLanguageCodesApi, TranslatorApi, KnowledgeService, AutosaveService, ValidatorService, logger) {
    var vm = this;
    var isSubmit = false;
    ...
    $scope.QuestionsEnglish.description = 'Technical Alert Description <strong class="req">*</strong><br><small>Write the submission in concise manner</small>';
    $scope.QuestionsEnglish.recommendation = 'Recommendation <strong class="req">*</strong><br><small>Write the submission in concise manner</small>';
    ...
    KnowledgeDiscoveryApi.improveByType($stateParams.type, $stateParams.ln, $stateParams.id).then(function (res) {
      ...
      $scope.Field.original_description= res.originalKnowledge.description;
      ...
      $scope.Field.description = res.translatedKnowledge.description;
