(function () {
    ...
    angular
        ...
        .controller('KnowledgeBestPracticesImproveController', KnowledgeBestPracticesImproveController);

    /** @ngInject */
  function KnowledgeBestPracticesImproveController($scope, $state, $stateParams, $location, $anchorScroll, $timeout, KnowledgeDiscoveryApi, MasterDataLanguageCodesApi, TranslatorApi, KnowledgeService, AutosaveService, ValidatorService, logger) {
    var vm = this;
    var isSubmit = false;
