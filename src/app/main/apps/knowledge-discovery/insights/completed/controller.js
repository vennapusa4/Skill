(function () {
    ...
    angular
        ...
        .controller('KnowledgeInsightsCompletedController', KnowledgeInsightsCompletedController);

    /** @ngInject */
    function KnowledgeInsightsCompletedController($scope, $stateParams, KnowledgeDiscoveryApi, Utils) {
        ...
        $scope.getNewForm = function () {
            switch ($stateParams.type) {
                ...
                case 'SEI':
                    return '/knowledge-discovery/insights/build';
                case 'Pub':
                default:
