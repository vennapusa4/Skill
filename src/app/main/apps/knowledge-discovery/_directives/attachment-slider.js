...
(function () {
    ...
    angular.module('app.knowledgeDiscovery')
        .directive('attachmentSlider', attachmentSlider);

    /** @ngInject */
    function attachmentSlider(KnowledgeDiscoveryApi, KnowledgeService, Utils, logger, appConfig) {
        ...
        return {
            ...
            templateUrl: 'app/main/apps/knowledge-discovery/_directives/attachment-slider.html',
        };
    }
})();
