(function () {
  ...
  angular
    ...
    .controller('ExpertInterviewDetailController', ExpertInterviewDetailController);

  /** @ngInject */
  function ExpertInterviewDetailController($scope, $timeout, $stateParams, $rootScope, logger, appConfig, $location,
    $anchorScroll, ExpertInterviewApi, KnowledgeDiscoveryApi) {
    var vm = this;

    vm.expertInterviewId = $stateParams.id;
    vm.config = appConfig;
    vm.expertInterview = {};
    ...
    function getExpertInterviewDetail() {
      ExpertInterviewApi.getDetails(vm.expertInterviewId).then(function (response) {
    ...
    function getTrendDetails() {
      ...
      ExpertInterviewApi.api.trend.query({}, trendRequest,
        function (response) {
          var data = [];
          // vm.showTrendGraph = true; // ToDo: Comment when have Data
