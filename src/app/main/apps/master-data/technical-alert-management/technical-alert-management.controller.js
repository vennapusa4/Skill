(function () {
    ...
    angular
        ...
        .controller('technicalAlertManagementAdminController', TechnicalAlertManagementAdminController);

    /** @ngInject */
    function TechnicalAlertManagementAdminController($scope, KnowledgeManagementApi, $timeout, $window, Utils, CommonApi, BulkUploadApi, UserProfileApi, KnowledgeDiscoveryApi, SearchApi, logger, MasterDataGameMechanicsApi) {
        var vm = this;
        vm.pageSize = 10;
        vm.searchTerm = '';
        vm.checkedIds = {};
            ...
            transport: {
                read: function (options) {
                    ...
                    var filterBy = [
                        ...
                        { field: 'Types', value: 'Technical Alerts' }
                    ];
        ...
        vm.gridOptions = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (dataItem) {
                        ...
                        } else if (dataItem.status == "Submit" || dataItem.status == "Approve") {
                            result = "<a href='/knowledge-discovery/" + dataItem.id + "'> " + dataItem.title + "</a>"
                        }
                        else {
                            result = "<a href='javascript: void(0)'> " + dataItem.title + "</a>"
                        }
            ...
            excelExport: function (e) {
                ...
                function getExcelTA(row) {
                    ...
                    //     { value: row.groupTechnicalAuthority }
