(function () {
  ...
  angular
    ...
    .controller('GameMechanicsLevelsController', GameMechanicsLevelsController);

  /** @ngInject */
  function GameMechanicsLevelsController($scope, $timeout, MasterDataGameMechanicsApi, $window, $state) {
    ...
    $scope.mainGridOptions = {
      ...
      columns: [
        ...
        },
        {
          ...
          title: "Level Name",
          template: function (dataItem) {
            return "<a href='javascript: void(0)' ng-click='editItem(" + dataItem.id + ")'>" + dataItem.levelName + "</a>";
          }
        },
        {
          field: "description",
