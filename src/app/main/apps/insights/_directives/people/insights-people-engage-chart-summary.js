...
(function () {
    ...
    angular.module('app.insights')
        .directive('insightsPeopleEngageChartSummary', insightsPeopleEngageChartSummary);
    /** @ngInject */
    function insightsPeopleEngageChartSummary() {
        return {
            restrict: 'AE',
            replace: true,
            scope: {
                ...
                $scope.drawChart = function () {
                    ...
                    _.each(dataInput.items, function (segment, index) {
                        ...
                        _.each(segment.items, function (item, idd) {
                            _.each(item.engagementChartResponses, function (c, idx) {
            ...
            templateUrl: 'app/main/apps/insights/_directives/people/insights-people-engage-chart-summary.html',
        };
    }
})();
