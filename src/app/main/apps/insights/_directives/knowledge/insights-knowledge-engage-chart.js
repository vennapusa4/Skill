...
(function () {
    ...
    angular.module('app.insights')
        .directive('insightsKnowledgeEngageChart', insightsKnowledgeEngageChart);
    /** @ngInject */
    function insightsKnowledgeEngageChart() {
        return {
            restrict: 'AE',
            replace: true,
            scope: {
            ...
            templateUrl: 'app/main/apps/insights/_directives/knowledge/insights-knowledge-engage-chart.html',
        };
    }
})();
