(function () {
    ...
    angular
        .module('app.insights')
        .controller('InsightsKnowledgeController', InsightsKnowledgeController);

    /** @ngInject */
    function InsightsKnowledgeController($mdSidenav, $scope, $filter, $rootScope, api, $state, msNavigationService, dialog, InsightsApi, SearchApi, appConfig, InsightsCommonService, UserProfileApi) {
