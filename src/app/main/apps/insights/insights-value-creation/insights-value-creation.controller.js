(function () {
    ...
    angular
        .module('app.insights')
        .controller('InsightsValueCreationController', InsightsValueCreationController);

    /** @ngInject */
    function InsightsValueCreationController($mdSidenav, $scope, $filter, $rootScope, $timeout, api, $state, msNavigationService, dialog, InsightsApi, SearchApi, appConfig, InsightsCommonService, UserProfileApi) {
        ...
        $scope.switchMode = function () {
            ...
            $rootScope.$broadcast('switchMode', { isShowAll: $scope.isShowAll });
        }
