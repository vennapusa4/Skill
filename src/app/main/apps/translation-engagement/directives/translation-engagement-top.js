...
(function () {
    ...
    angular.module('app.translationEngagement')
        .directive('translationEngagementTop', translationEngagementTop);
    /** @ngInject */
    function translationEngagementTop() {
        return {
            restrict: 'AE',
            replace: true,
            scope: {},
            ...
            templateUrl: 'app/main/apps/translation-engagement/directives/translation-engagement-top.html'
        };
    }
})();
