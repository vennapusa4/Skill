(function () {
  ...
  angular
    ...
    .controller('AdminSystemSearchTermsController', AdminSystemSearchTermsController);

  /** @ngInject */
  function AdminSystemSearchTermsController($scope, $timeout, MasterDataGameMechanicsApi, $window, $state) {
    ...
    $scope.mainGridOptions = {
      ...
      columns: [
        ...
        },
        {
          ...
          width: "20%",
          template: function (dataItem) {
            return "<a href='javascript: void(0)' ng-click='editItem(" + dataItem.id + ")'>Saharbuddin Bahar (PROD/ABF)</a>";
          }
        },
        {
          field: "badgeImageUrl",
        ...
        },
        {
          field: "description",
          title: "Division",
          template: "GROUP DIGITAL"
          
        },
        {
          field: "pointsRequired",
          title: "Date",
          template: "29 OCT 2020"
        },
        {
          field: "pointsRequired",
          title: "time",
