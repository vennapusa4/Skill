(function () {
  ...
  angular
    ...
    .controller('AdminSystemSearchTermsCountController', AdminSystemSearchTermsCountController);

  /** @ngInject */
  function AdminSystemSearchTermsCountController($scope, $timeout, MasterDataGameMechanicsApi, $window, $state) {
