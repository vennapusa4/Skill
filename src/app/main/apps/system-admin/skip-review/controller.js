(function () {
  ...
  angular
    ...
    .controller('AdminSystemSkipReviewController', AdminSystemSkipReviewController);

  /** @ngInject */
  function AdminSystemSkipReviewController($scope, $timeout, MasterDataGameMechanicsApi, $window, $state) {
    $scope.pageSize = 10;
    $scope.Keyword = '';
    $scope.checkedIds = {};
