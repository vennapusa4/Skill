(function () {
    ...
    angular
        ...
        .controller('MyContributionController', MyContributionController);

    /** @ngInject */
    function MyContributionController($scope, KnowledgeDocumentApi, SearchApi) {
        var vm = this;
        vm.FilterSources = []; //id, name
        vm.arrSortby = [
            ...
            dataSource: {
                ...
                transport: {
                    read: function (options) {
                        return SearchApi.SearchSuggestionsWithoutContributor(options);
                    }
                },
                group: { field: "type" }
            },
        ...
        vm.Search = function () {
            ...
            KnowledgeDocumentApi.getMyContributions(postData).then(function (data) {
