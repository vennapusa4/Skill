(function () {
    ...
    angular
        ...
        .controller('MyLibraryCollectionController', MyLibraryCollectionController);

    /** @ngInject */
    function MyLibraryCollectionController($rootScope, $scope, KnowledgeDocumentApi, SearchApi) {

        $rootScope.libraryType = 'Collections';
        ...
        vm.Search = function () {
            ...
            KnowledgeDocumentApi.GetMyCollectionLibrary(postData).then(function (data) {
