...
(function () {
    ...
    angular.module('app.home')
        .directive('popularSearch', popularSearch);

    /** @ngInject */
    function popularSearch(KnowledgeDocumentApi, $rootScope) {
        ...
        return {
            ...
            templateUrl: 'app/main/apps/landing-page/directives/popular-search.html',
        };
    }
})();
