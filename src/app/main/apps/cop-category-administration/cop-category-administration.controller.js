(function () {
    ...
    angular
      ...
      .controller('copCategoryAdministration', copCategoryAdministration);
  
    /** @ngInject */
    function copCategoryAdministration($scope, $timeout, MasterDataCopCategoryApi, $window, InsightsCommonService) {
      var vm = this;
